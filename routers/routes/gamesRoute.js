...
//
const { getGames, postGame,AddextraImg,deleteGame,getGamee,addComment,deleteComment,updateGame } = require("../controllers/Game");
...
GamesRoute.post("/img/:id",authentication,AddextraImg)
